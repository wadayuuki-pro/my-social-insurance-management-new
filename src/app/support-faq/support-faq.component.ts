  ...
  faqCategories = [
    {
      ...
      items: [
        ...
        { question: '新規メンバー追加時の初期パスワードは何になりますか？', answer: '社員IDと同じ値になります。ログイン後はすぐにパスワード変更処理を行うようにしてください。' },
    ...
    },
    {
      name: '操作関連',
      items: [
        { question: 'インポートファイルは見本はありますか？', answer: '一度エクスポートしていただいてそのファイルに付け加える形でご利用ください。' },
